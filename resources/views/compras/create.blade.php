          ...
          <div class="card card-secondary">
			...
			<div class="row">
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
					 ...
					 <input type="number" name="pcosto" id="pcosto" class="form-control" style="text-align:center;" maxlength="7" placeholder="">
					 </div>
				</div>
