            ...
            <div class="card-body">
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p>                                    <a href="{{ route('productoCotizado.editar',$producto->id) }}" class="btn btn-link" data-toggle="tooltip" title="Editar Producto" data-original-title="Editar Producto"><button type="button" class="btn btn-warning btn-sm">Editar Producto</button></a><p>
                  </div>
                          ...
                          <div class="form-group">
                              ...
                              <label>Descripcion</label>
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control input-lg" placeholder="Enter ..." id="pid" name="id">
