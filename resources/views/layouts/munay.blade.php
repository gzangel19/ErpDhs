        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview">
                <a href=" {{ url('/Munay/cajas') }}" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                    <a href="{{ url('/pagos/index') }}" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                <a href=" {{ url('/Munay/Clientes') }}" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                <a href="{{ url('/Munay/Materias_Primas') }}" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                <a href="{{ url('/Munay/Productos') }}" class="nav-link">
