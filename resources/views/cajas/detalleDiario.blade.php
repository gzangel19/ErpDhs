              ...
              <div class="row mb-2">
                ...
                <div class="col-lg-6 col-md-6 col-dm-6 col-xs-12" id="guardar1">
                  <div class="form-group">
                      ...
                      <form class="" action="{{ route('cajas.abrirCerrar',$cajas->id)}}" >
                          ...
                          <a class="btn btn-dark" href="{{route('pdf.reporteCajaDiario')}}" role="button">Imprimir</a>
                      </form>
                      @endif
          ...
          <div class="card card-secondary">
            ...
            <table class="table table-hover text-nowrap" id="tablecliente">
              ...
              <tr>
                    ...
                    <td style ="text-align:center;">{{ $movimiento->num_cheque}} </td>
              </tr>       
              @endforeach   
              </tbody>    
            </table>
