              ...
              <table class="table table-hover text-nowrap" id="datos">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center">
                     <a href="{{ route('presupuesto.seleccionarNegocio', $cliente->id) }}"  class="btn btn-success" data-toggle="tooltip" title="Seleccionar" data-original-title="Seleccionar"><i class="fas fa-check"></i></a>
                    </td>
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{ route('presupuesto.storeCliente')}}" role="form">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div class="form-group">
                          ...
                          <label>Monto Cuenta AR$</label>

                          <input type="text" class="form-control" id="montoCuentaPesos" name="montoCuentaPesos" value="0" disabled="true">
