...
<div id="page_pdf">
		...
		<tr>
			...
			<td class="info_empresa">
				<div>			
					...
					<span class="h2">PRODUCTOS DE DISEÑO</span>
    ...
    <table id="factura_detalle">
			...
			<thead>
				<tr>
					<th width="30px" class="textcenter" >Hora</th>
					<th width="250px" class="textcenter" >Descripción</th>
					<th class="textcenter" width="50px">Ingreso</th>
					<th class="textcenter" width="50px"> Egreso </th>
                    <th class="textcenter" width="80px"> Tipo </th>
				</tr>
			</thead>
			<tbody id="detalle_productos">
                @foreach($movimientos as $movimiento)
				<tr>
					<td class="textcenter">{{$movimiento->getFromDay($movimiento->fecha)}}</td>
					<td class="textcenter"> {{$movimiento->descripcion}} </td>
					<td class="textright"> AR$ {{$movimiento->entrada}} </td>
					<td class="textright"> AR$ {{$movimiento->salida}} </td>
                    <td class="textright"> {{$movimiento->tipo}} </td>
				</tr>
				@endforeach
				<tr>
					<td></td>
