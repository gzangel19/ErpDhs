                        ...
                        <tbody>
                          ...
                          @foreach ($materiales as $material)
                            ...
                            <tr>
                                ...
                                <td>
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#ModalEditar" title="Agregar" data-original-title="Editar Materia Prima" onclick="SeleccionarMateriaPrima()">Editar</button>
                                </td> 
                            </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="card-body">
                  ...
                  <form method="post" action="{{ route('munay.materiales.store')}}" role="form" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="card-body">
                  ...
                  <form method="post" action="{{ route('munay.materiales.edit')}}" role="form" enctype="multipart/form-data">
