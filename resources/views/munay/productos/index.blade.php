...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        ...
        <a href="{{url('/Munay/Productos')}}" class="nav-link"> <i class="fas fa-boxes"></i> Productos  </a>
...
<div class="container-fluid">
    ...
    <div class="panel shadow">
      ...
      <div class="header">
          ...
          <h2 class="title"> <a href="{{url('/Munay/Productos')}}"> <i class="fas fa-boxes"></i> Productos </a>  </h2> 
      ...
      <div class="inside">
          ...
          <nav class="navbar navbar-light bg-light">
            ...
            <a class="navbar-brand"></a>
              ...
              <form class="form-inline" action="{{ url('/Munay/Productos') }}">
        ...
        <div class="btns mtop16">
            ...
            <a href="{{url('/cotizadores/cargar')}}" class="btn btn-primary" title="Nuevo Producto"><i class="fas fa-plus"></i> Agregar </a>
