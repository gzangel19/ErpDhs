...
<div class="container-fluid">
        ...
        <div class="panel shadow">
            ...
            <div class="inside">
                ...
                @if (getValueJS(Auth::user()->permisosERP,'pedidosSearch'))
                    ...
                    <tr>
                        ...
                        <td> 
                          <div class="opts">
                             ...
                             @if (getValueJS(Auth::user()->permisosERP,'pedidosShow'))
